...
After completing KYC, users need a clear confirmation that onboarding is complete and a path forward into the app. The "You're all set" screen closes the onboarding funnel with a celebratory moment and two clear CTAs — fund their account to start trading, or explore markets first.
...
- Two full-width action buttons (mt-8, gap-3, px-6): "Fund Account & Trade" (primary/accent bg → navigates to 'deposit') and "Explore Markets" (secondary/surface-light bg → navigates to 'home')
